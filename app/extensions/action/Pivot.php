...
use app\extensions\action\Pivot_Count;
use app\extensions\action\Pivot_Callback;

class Pivot extends \lithium\action\Controller {
    /**
    ...
    public function fetch($fetchType=null)
    {
		...
		if(isset($this->_column[1])){
        $column = $this->_column[1];
		}else{$column="";}

//		$Pivot_Callback = new Pivot_Callback();
//		$Pivot_Call = new Pivot_Count();		
