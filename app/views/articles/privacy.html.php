rBitCoin, has created the following Privacy Policy to let you know what information we collect when you visit our site, why we collect it and how it is used. This Privacy Policy explains the data collection and use practices of rBitCoin.com website and mobile apps; it does not apply to other online or offline rBitCoin, Inc. sites, products or services. The terms “you,” “your,” and “yours” refer to the customer/purchaser utilizing our Site. The terms “rBitCoin, Inc.,” “we,” “us,” and “our” refer to rBitCoin, Inc.. By using this web site, you consent to the data practices prescribed in this statement. We may periodically make changes to this Privacy Policy that we will include on this page. It is your responsibility to review this Privacy Policy frequently and remain informed about any changes to it, so we encourage you to visit this page often.

<h3>How we collect information about you</h3>

When you visit the rBitCoin website or use rBitCoin services or rBitCoin application, we collect information sent to us by your computer, mobile phone, or other access device. This information may include your IP address, device information including, but not limited to, identifier, name and type, operating system, location, mobile network information and standard web log information, such as your browser type, traffic to and from our site and the pages you accessed on our website.

If you create an account or use rBitCoin services, we may collect the following types of information:

    Contact information - your name, address, phone, email, Skype ID and other similar information.
    Financial information - the full bank account numbers and/or credit card numbers that you link to your rBitCoin account or give us when you use paid rBitCoin services.

Before permitting you to use rBitCoin services, we may require you to provide additional information we can use to verify your identity or address or manage risk, such as your date of birth, social security number or other information. We may also obtain information about you from third parties such as credit bureaus and identity verification services.

When you use rBitCoin services, we collect information about your transactions and your other activities on our website and we may collect information about your computer or other access device for fraud prevention purposes.

You may choose to provide us with access to certain personal information stored by third parties such as social media sites (such as Facebook and Twitter). The information we have access to varies by site and is controlled by your privacy settings on that site and your authorization. By associating an account managed by a third party with your rBitCoin account and authorizing rBitCoin to have access to this information, you agree that rBitCoin may collect, store and use this information in accordance with this Privacy Policy.

In order to help protect you from fraud and misuse of your personal information, we may collect information about your use and interaction with our website or rBitCoin services. For example, we may evaluate your computer, mobile phone or other access device to identify any malicious software or activity that may affect the availability of rBitCoin services.
...
When you access our website or content or use our application or rBitCoin services, we or companies we work with may place small data files called cookies or pixel tags on your computer or other device. We use these technologies to:

    Recognize you as a rBitCoin customer;
    Customize rBitCoin services, content, and advertising;
...
You may encounter rBitCoin cookies or pixel tags on websites that we do not control. For example, if you view a web page created by a third party or use an application developed by a third party, there may be a cookie or pixel tag placed by the web page or application. Likewise, these third parties may place cookies or pixel tags that are not subject to our control and the rBitCoin Privacy Policy does not cover their use.
...
We store and process your personal information on our computers in the US and elsewhere in the world where rBitCoin facilities or our service providers are located, and we protect it by maintaining physical, electronic and procedural safeguards in compliance with applicable US federal and state regulations. We use computer safeguards such as firewalls and data encryption, we enforce physical access controls to our buildings and files, and we authorize access to personal information only for those employees who require it to fulfill their job responsibilities.
...
Our primary purpose in collecting personal information is to provide you with a secure, smooth, efficient, and customized experience. We may use your personal information to:
    ...
    Provide rBitCoin services and customer support you request;
    Process transactions and send notices about your transactions;
    Resolve disputes, collect fees, and troubleshoot problems;
    Prevent potentially prohibited or illegal activities;
    Customize, measure, and improve rBitCoin services and the content and layout of our website and applications;
...
We will not sell or rent your personal information to third parties for their marketing purposes without your explicit consent. We may combine your information with information we collect from other companies and use it to improve and personalize rBitCoin services, content and advertising.

How we share personal information with other rBitCoin users

To process your payments, we may share some of your personal information with the person or company that you are paying or that is paying you. Your contact information, date of sign-up, the number of payments you have received from verified rBitCoin users, and whether you have verified control of a bank account are provided to other rBitCoin users who you transact with through rBitCoin. In addition, this and other information may also be shared with third parties when you use these third parties to access rBitCoin services. Unless you have agreed to it, these third parties are not allowed to use this information for any purpose other than to facilitate your transactions using rBitCoin services.

If you are buying goods or services and pay using rBitCoin, we may also provide the seller with your shipping and confirmed billing address to help complete your transaction with the seller. The seller is not allowed to use this information to market their services to you unless you have agreed to it. If an attempt to pay your seller fails, or is later invalidated, we may also provide your seller with details of the unsuccessful payment. To facilitate dispute resolutions, we may provide a buyer with the seller’s address so that goods can be returned to the seller.

We work with third parties, including merchants, to enable them to accept or facilitate payments from or to you using rBitCoin. In doing so, a third party may share information about you with us, such as your email address or mobile phone number to inform you that a payment is sent to you or when you attempt to pay that merchant or through that third party. We use this information to confirm that you are a rBitCoin customer and that bitcoin as a form of payment can be enabled, or where a payment is sent to you, to send you notification that you have received a payment. Also, if you request that we validate your status as a rBitCoin customer with a third party, we will do so. Please note that merchants you buy from and contract with have their own privacy policies, and rBitCoin cannot be held responsible for their operations, including, but not limited to, their information practices.
...
rBitCoin will not sell or rent any of your personal information to third parties for their marketing purposes and only shares your personal information with third parties as described in this policy.

If you establish a rBitCoin account indirectly on a third party website or via a third party application, any information that you enter on that website or application (and not directly on a rBitCoin website) will be shared with the owner of the third party website or application and your information may be subject to their privacy policies.
...
You can review and edit your personal information at any time by logging in to your account and clicking the Profile or My Account tab. If you close your rBitCoin account, we will mark your account in our database as "Closed," but will keep your account information in our database. This is necessary in order to deter fraud, by ensuring that persons who try to commit fraud will not be able to avoid detection simply by closing their account and opening a new account. However, if you close your account, your personally identifiable information will not be used by us for any further purposes, nor sold or shared with third parties, except as necessary to prevent fraud and assist law enforcement, as required by law or in accordance with this Privacy Policy.

How you can contact us about privacy questions

If you have questions or concerns regarding this policy, you should contact us on our support page or by writing to us at rBitCoin.