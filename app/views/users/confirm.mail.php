...
Or use this confirmation code: <?=$verification?> for your email address: <?=$email?> on the page http://www.rbitco.in/users/email

Once you confirm your email address, you can send all your bitcoins to <?=$bitcoinaddress?>. You will see the balance of this on the server.
...
We do not spam. We are the only BitCoin service in India.
