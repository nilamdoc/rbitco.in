...
$pdf->SetSubject('Real Bitcoin Pen');
$pdf->SetKeywords('Real Bitcoin pen:');
$pdf->SetTitle('Real Bitcoin pen:');
...
//				$btcword = ucwords($function->number_to_words($value))." BTC";
		...
		//		print_r($address);
				$pdf->AddPage('P');
				$pdf->Image(LITHIUM_APP_PATH.'/webroot/img/bitcoin-pen.jpg', 30, 10, 143, 267, '', '', '', false, 300, '', false, false, 0);
