...
<p>Click on the link below to restore your private keys to another wallet:<br>
<a href="https://rbitco.in/closure/index/<?=$data['address']?>">Get Private keys</a><br><br>
https://rbitco.in/closure/index/<?=$data['address']?><br>
You will be required to enter your username: <strong><?=$data['username']?></strong> and this email address.
</p>
